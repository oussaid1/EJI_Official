...
class Deffensive extends StatefulWidget {
  Deffensive({Key key, this.selectedSquad}) : super(key: key);
  final List<Player> selectedSquad;
  @override
  _DeffensiveState createState() => _DeffensiveState();
}

class _DeffensiveState extends State<Deffensive> {
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    buildPositionedPlayer(
                        ...
                        right: Get.width / 1.8,
                        playerCandidate:
                            selectedSquad.pCMF1 ?? new Player.dummy()),
                    //CMF
                    buildPositionedPlayer(
                        top: Get.height / 2.8,
                        left: Get.width / 1.8,
                        playerCandidate: selectedSquad.pDMF ??
                            selectedSquad.pCMF2 ??
                            new Player.dummy()),
                    //LMF
                    buildPositionedPlayer(
